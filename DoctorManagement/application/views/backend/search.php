...
?>
    <ul class="input-group">
        <li class="list-group-item">
            <div class="radio">
                <label><input type="radio" name="category" value="Plastic-Surgery">Plastic Surgery</label>
            </div>
        </li>

        <li class="list-group-item">
            <div class="radio">
                <label><input type="radio" name="category" value="Orthopedic">Orthopedics</label>
            </div>
        </li>

        <li class="list-group-item">
            <div class="radio">
                <label><input type="radio" name="category" value="Oncology">Oncology</label>
            </div>
        </li>

        <li class="list-group-item">
            <div class="radio">
                <label><input type="radio" name="category" value="Fertility">Fertility</label>
            </div>
        </li>

        <li class="list-group-item">
            <div class="radio">
                <label><input type="radio" name="category" value="Dental">Dental</label>
            </div>
        </li>

        <li class="list-group-item">
            <div class="radio">
                <label><input type="radio" name="category" value="Cardiology">Cardiology</label>
            </div>
        </li>

        <li class="list-group-item">
            <div class="radio">
                <label><input type="radio" name="category" value="Bariatric">Bariatric</label>
            </div>
        </li>
    </ul>

<?php
    $final = str_replace(', ', '', $location);
    $replace = str_replace(' ', '-', $final);
?>
    ...
    <script>
        ...
        $('input[type="radio"]').click(function(e) {
            ...
            var location = '<?php echo $replace; ?>';

            window.location.href = base_url +'search/'+ procedure +'/'+ location +'/distance-desc';
        });
