        ...
        <div class="col-lg-6">
            ...
            <div class="form-group info-block">
                ...
                <div class="form-group">
                    ...
                    <?= form_error('title'); ?>
                    <input type="text" class="form-control" id="title" name="title"  value="<?=$doctor['title']?>" >
                </div>
                <div class="row">
                    <div class="col-lg-8">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="field" name="field" >
                                <option <?php if($doctor['field'] == "Plastic Surgery") echo "selected";?>>Plastic Surgery</option>
                                <option <?php if($doctor['field'] == "Orthopedic") echo "selected";?>>Orthopedic</option>
                                <option <?php if($doctor['field'] == "Spine") echo "selected";?>>Spine</option>
                                <option <?php if($doctor['field'] == "Dental") echo "selected";?>>Dental</option>
                                <option <?php if($doctor['field'] == "Fertility") echo "selected";?>>Fertility</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-lg-4">
        ...
        <div class="col-lg-6">
            ...
            <div class="form-group info-block">
                ...
                <div class="row" style="margin-top:15px">
                    <div class="form-group">
                        <div class="col-xs-6 col-lg-6 ">
                            <label for="is_street_image">Full Profile View : </label>                    
                            <input type="checkbox" id="is_full_profile"  name="is_full_profile" <?php if($doctor['is_full_profile'] == 1) echo("checked");?>>
                        </div>
                    </div>
                </div>
                ...
                <div class="row" style="margin-top:15px">
                    <div class="form-group">
                        <div class="col-xs-6 col-lg-6 ">
                            <label for="is_street_image">BME view : </label>                    
                            <input type="checkbox" id="is_bme"  name="is_bme" <?php if($doctor['is_bme'] == 1) echo("checked");?>>
                        </div>
                    </div>
                </div>
                ...
                <div class="row" style="margin-top:15px">
                    <div class="form-group">
                        <div class="col-xs-6 col-lg-6 ">
                            <label for="is_street_image">Street Image View : </label>                    
                            <input type="checkbox" id="is_street_image"  name="is_street_image" <?php if($doctor['is_street_image'] == 1) echo("checked");?>>
                        </div>
                    </div>
                </div> 
                
                <div class="row" id="street_view_image_div" style="margin-top:15px; <?php if($doctor['is_street_image'] == 0) echo('display:none;');?>">
                    <div class="form-group">
                        <div class="col-xs-8 col-lg-8 ">                            
                            <img style="width:350px; height:100px " src="<?=base_url("/public/images/doctors/location/" . $doctor["first_name"] . "_" . $doctor["last_name"] . ".jpg"); ?>">
                        </div>                                         
                        <div class="col-xs-4 col-lg-4 ">   
                            <input id="street_image" type="file" class="file-loading" name="street_image">                                                     
                        </div>
                    </div>
                </div>               
